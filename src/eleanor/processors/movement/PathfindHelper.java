...
public class PathfindHelper {
    ...
    public static Vector3f selectStep(Creature source, Vector3f target) {
        ...
        for (int i = 0; i < rounds; ++i) {
            Vector3f rotated = PathfindHelper.Rotate(source, sourcePoint.x, sourcePoint.y, targetPoint.x, targetPoint.y, futureDistance, i * PATHFIND_ANGLE_STEP - offset, targetPoint.z);
            if (targetPoint.z - rotated.z > source.getObjectTemplate().getBoundRadius().getUpper() || rotated.z == 0.0f) continue;

...
extends CreatureMoveController<Npc> {
    ...
    public void moveToTargetObject() {
        if (this.started.compareAndSet(false, true)) {
            if (((Npc)this.owner).getAi2().isLogging()) {
                AI2Logger.moveinfo((Creature)this.owner, "MC: moveToTarget started");
            }
    ...
    public void moveToPoint(float x, float y, float z) {
        if (this.started.compareAndSet(false, true)) {
            if (((Npc)this.owner).getAi2().isLogging()) {
                AI2Logger.moveinfo((Creature)this.owner, "MC: moveToPoint started");
            }
    ...
    public void moveToNextPoint() {
        if (this.started.compareAndSet(false, true)) {
            if (((Npc)this.owner).getAi2().isLogging()) {
                AI2Logger.moveinfo((Creature)this.owner, "MC: moveToNextPoint started");
            }
            this.destination = Destination.POINT;
            this.updateLastMove();
            MoveTaskManager.getInstance().addCreature((Creature)this.owner);
    ...
    public void moveToDestination() {
        if (((Npc)this.owner).getAi2().isLogging()) {
            AI2Logger.moveinfo((Creature)this.owner, "moveToDestination destination: " + (Object)((Object)this.destination));
        }
        ...
        if (!((Npc)this.owner).canPerformMove() || ((Npc)this.owner).getAi2().getSubState() == AISubState.CAST) {
            if (((Npc)this.owner).getAi2().isLogging()) {
                AI2Logger.moveinfo((Creature)this.owner, "moveToDestination can't perform move");
            }
        ...
        if (!this.started.get() && ((Npc)this.owner).getAi2().isLogging()) {
            AI2Logger.moveinfo((Creature)this.owner, "moveToDestination not started");
        }
    ...
    public void setCurrentRoute(List<RouteStep> currentRoute) {
        if (currentRoute == null) {
            AI2Logger.info(((Npc)this.owner).getAi2(), String.format("MC: setCurrentRoute is setting route to null (NPC id: {})!!!", ((Npc)this.owner).getNpcId()));
        } else {
